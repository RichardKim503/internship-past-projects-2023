...
//		button[r][c].showIt(g);
//		
//		if(button[r][c+1].getState() == 0 || button[r][c+1].getState() == 1) {
//			removeAdjacentButtons( g,r, c+1);
//		}
//		if(button[r-1][c].getState() == 0 || button[r-1][c].getState() == 1) {
//			removeAdjacentButtons( g,r-1, c);
//		}
//		if(button[r][c-1].getState() == 0 || button[r][c-1].getState() == 1) {
//			removeAdjacentButtons( g,r, c-1);
//		}
//		if(button[r+1][c+1].getState() == 0 || button[r+1][c+1].getState() == 1) {
...
//		}
		...
		if(button[r+1][c].getState() == 0 || button[r+1][c].getState() == 1) {
			button[r+1][c].showIt(g);
		}
		if(button[r][c+1].getState() == 0 || button[r][c+1].getState() == 1) {
			button[r][c+1].showIt(g);
		}
		if(button[r-1][c].getState() == 0 || button[r-1][c].getState() == 1) {
			button[r-1][c].showIt(g);
		}
...
//		button[r][c].showIt(g);
//		
//		if(button[r][c].getNoOfMinesAround() == 0) {
//			button[r+1][c].showIt(g);
//			button[r-1][c].showIt(g);
//			button[r][c+1].showIt(g);
//			button[r][c-1].showIt(g);
...
//			button[r-1][c+1].showIt(g);
//			
//			if(button[r+1][c].getNoOfMinesAround() == 0) {
//				removeAdjacentButtons(g,r+1, c);
//			}
//			if(button[r-1][c].getNoOfMinesAround() == 0) {
//				removeAdjacentButtons(g,r-1, c);
//			}
//			if(button[r][c+1].getNoOfMinesAround() == 0) {
//				removeAdjacentButtons(g,r, c+1);
//			}
//			if(button[r][c-1].getNoOfMinesAround() == 0) {
//				removeAdjacentButtons(g,r, c-1);
//			}
//			if(button[r+1][c+1].getNoOfMinesAround() == 0) {
//				removeAdjacentButtons(g,r+1, c+1);
//			}
//			if(button[r-1][c-1].getNoOfMinesAround() == 0) {
//				removeAdjacentButtons(g,r-1, c-1);
